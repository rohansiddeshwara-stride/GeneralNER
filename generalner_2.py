...
def list_of_lists_to_dict(list_of_lists):
    ...
    for inner_list in list_of_lists:
      key = inner_list[0]
      value = {"text" : inner_list[1], "start" : inner_list[2], "end" : inner_list[3]}

      # Check if the key already exists in the dictionary
      if key in result_dict:
        f=0
        for i in result_dict[key]:
          if i['text']==value['text'] and i['start']==value['start'] and i['end']==value['end'] :
            f=1
...
input_sentence = "Cupertino is headquartered in Cupertino, California. Visit their website at https://www.apple.com. $200 USD 500"
